...
i686-elf-gcc -c lib/kb.c -o kbf.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra -Wpedantic -Wshadow -Werror -g
i686-elf-gcc -T linker.ld -o myos.bin -ffreestanding -O2 -nostdlib boot.o kmain.o ttyf.o gdtf.o gdt.o idtf.o memf.o picf.o idt.o kbf.o -lgcc -g
